...
Create view user_event(username, course_code, datetime, description, room ) as select UHS.username,
UHS.course_code, CE.datetime, CE.description, CE.room from user_has_subject as UHS, course_event as CE where
CE.course_code = UHS.course_code, group by UHS.username
