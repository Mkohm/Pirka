...
class TestDatabaseExtractor(TestCase):
    ...
    def test_get_exam_date_no_exam(self):
        self.assertEqual("No date available because there is another assessment form.",
                         DatabaseExtractor.get_exam_date("TDT4140"))
        self.assertEqual("No date available because there is another assessment form.",
    ...
    def test_assessment_form_written(self):
        self.assertEqual("Assessment form in TDT4100 Object-Oriented Programming is Written examination",
                         DatabaseExtractor.get_assessment_form("TDT4100"))
        self.assertEqual("Assessment form in TDT4105 Information Technology, Introduction is Written examination",
                         DatabaseExtractor.get_assessment_form("TDT4105"))

    # OK
    def test_assessment_form_work(self):
        self.assertEqual("Assessment form in TDT4140 Software Engineering is Work",
                         DatabaseExtractor.get_assessment_form("TDT4140"))
        self.assertEqual("Assessment form in TMR4160 Computer Methods for the Engineer is Work",
                         DatabaseExtractor.get_assessment_form("TMR4160"))

    # OK
    def test_assessment_form_combination(self):
        self.assertEqual(
            "Assessment form in TTK4135 Optimization and Control is Written examination and Work and Semester assignment",
            DatabaseExtractor.get_assessment_form("TTK4135"))
        self.assertEqual(
            "Assessment form in TMR4105 Marine Technology - Elementary Course is Work and Oral examination",
            DatabaseExtractor.get_assessment_form("TMR4105"))
        self.assertEqual("Assessment form in TMR4230 Oceanography is Oral examination and Semester assignment",
                         DatabaseExtractor.get_assessment_form("TMR4230"))
        self.assertEqual(
            "Assessment form in TMA4140 Discrete Mathematics is Written examination and Semester assignment",
            DatabaseExtractor.get_assessment_form("TMA4140"))
    ...
    def test_get_contact_name(self):
        ...
        self.assertEqual("The name of the contact person in TDT4140 Software Engineering is Pekka Kalevi Abrahamsson",
                         DatabaseExtractor.get_contact_name("TDT4140"))

    # OK
    def test_get_contact_mail(self):
        self.assertEqual(
            "The mail address of the contact person in TDT4140 Software Engineering is pekka.abrahamsson@ntnu.no",
            DatabaseExtractor.get_contact_mail("TDT4140"))
        self.assertEqual("The mail address of the contact person in TMA4115 Calculus 3 is aslak.buan@ntnu.no",
                         DatabaseExtractor.get_contact_mail("TMA4115"))

    # OK
    def test_get_contact_office_exists(self):
        self.assertEqual(
            "The office address of the contact person in TMA4105 Calculus 2 is Alfred Getz vei 1, Sentralbygg II * 1248",
            DatabaseExtractor.get_contact_office("TMA4105"))
        self.assertEqual(
            "The office address of the contact person in TDT4145 Data Modelling, Databases and Database Management Systems is Sem Sælands vei 9, IT-bygget * 209",
            DatabaseExtractor.get_contact_office("TDT4145"))

    # OK
    def test_get_contact_office_notexists(self):
        self.assertEqual("There is no existing office address in TTK4115 Linear System Theory",
                         DatabaseExtractor.get_contact_office("TTK4115"))

    # OK
    def test_get_contact_phone_exists(self):
        self.assertEqual(
            "The phone number of the contact person in TDT4145 Data Modelling, Databases and Database Management Systems is 73550382",
            DatabaseExtractor.get_contact_phone("TDT4145"))
        self.assertEqual("The phone number of the contact person in TTK4105 Control Systems is 73594358",
                         DatabaseExtractor.get_contact_phone("TTK4105"))

    # OK
    def test_get_contact_phone_notexists(self):
        self.assertEqual("There is no phone number available in TTK4115 Linear System Theory",
                         DatabaseExtractor.get_contact_phone("TTK4115"))

    # OK
    def test_get_course_name(self):
        self.assertEqual("The course name is TDT4140 Software Engineering",
                         DatabaseExtractor.get_course_name("TDT4140"))
    ...
    def test_getCredit(self):
        ...
        self.assertEqual("The course IØ1000 Leadership in a Practical Context is 15 credits.",
                         DatabaseExtractor.get_credit("IØ1000"))
    ...
    def test_get_prereq_knowledge_notexists(self):
        self.assertEqual("Prerequisite knowledge is not available for this course.",
                         DatabaseExtractor.get_prereq_knowledge("TMA4100"))
    ...
    def test_get_course_content(self):
        ...
        self.assertEqual("Statically determinate structures: Beams, plane trusses and frames. Axial force, "
                         ...
                         "differential equation for deformation of beams.",
                         DatabaseExtractor.get_course_content("TKT4116"))
    ...
    def test_get_course_material(self):
        self.assertEqual("Information will be given when the course starts.",
                         DatabaseExtractor.get_course_material("TTK4115"))
        self.assertEqual("Will be announced at the start of the course.",
                         DatabaseExtractor.get_course_material("TMA4100"))
        self.assertEqual(
    ...
    def test_get_teaching_form(self):
        ...
        self.assertEqual(
            ...
            DatabaseExtractor.get_teaching_form("TMA4130"))
